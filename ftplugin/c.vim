...
let b:makeprg.cpp = "g++ -Wall -std=c++20 % -o " . b:binary_filename
let b:makeprg.gdb = "g++ -Wall -g -O0 -std=c++20 % -o " . b:binary_filename
let b:makeprg.gtest = "g++ -Wall -lgmock_main -lgmock -g -O0 -std=c++20 % -o " . b:binary_filename
...
nmap <buffer> <silent> ,rr :call NormalRun(0)<CR>
